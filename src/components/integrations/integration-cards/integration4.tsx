      ...
      <motion.svg
        ...
        >
          <motion.path
            ...
            transition={{ duration: 0.25, delay: 1.25, type: "spring", damping: "50" }}
          ...
          <motion.path
            ...
            transition={{ duration: 0.25, delay: 1.35, type: "spring", damping: "50" }}
          ...
          <motion.path
            ...
            transition={{ duration: 0.25, delay: 1.55, type: "spring", damping: "50" }}
